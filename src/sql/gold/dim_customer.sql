-- =============================================================================
-- dim_customer: current customer snapshot from Bronze
-- full_refresh — CREATE OR REPLACE overwrites on every run
-- Source: negarabank.bronze.customers (full_snapshot extraction, no Silver SCD2)
-- One row per customer (latest load via QUALIFY).
-- =============================================================================
